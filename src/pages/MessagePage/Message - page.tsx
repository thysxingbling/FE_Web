...
const MessagePage: React.FC = () => {
  return (
    ...
    >
      <Sider width={300} style={{ backgroundColor: "#ffffff" }}>
        <Header
          style={{
            flexDirection: "row",
            marginTop: 50,
        ...
        <Footer style={{ marginLeft: "30px", height: 100 }}>
          ...
          >
            <Input
              ...
              style={{ borderRadius: "0px", height: 60 }}
            />
            <Button type="text">
              <MehOutlined />
            </Button>
      ...
      <Sider width={400} style={{ backgroundColor: "#ffffff" }}>
        ...
        <Content>
          ...
          >
            <div style={{display:"flex",justifyContent:"center",alignItems:"center",width: 350,height:310,flexDirection:"column",borderBottom:'6px solid gray'}}>
            <Avatar
            ...
            <div style={{width:350 , height:150 , borderBottom:'6px solid gray', display:'flex', flexDirection:'column'}}>
